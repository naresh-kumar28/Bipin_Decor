...
## Create .env.docker file for backend
Create a copy of .env and name it as ".env.docker" inside /backend-drf/ folder
```sh
...
Create a new file ".env.production" inside /backend-drf/ folder
```sh
POSTGRES_DB=<YOUR_DOCKER-DB>
